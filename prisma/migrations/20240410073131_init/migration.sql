...
CREATE TABLE [dbo].[DataSource] (
    ...
    CONSTRAINT [DataSource_id_key] UNIQUE NONCLUSTERED ([id])
);
...
-- AddForeignKey
ALTER TABLE [dbo].[DataSource] ADD CONSTRAINT [DataSource_userId_fkey] FOREIGN KEY ([userId]) REFERENCES [dbo].[User]([id]) ON DELETE CASCADE ON UPDATE CASCADE;
